...
This algorithm is mainly used when the objects have a low number of faces, as it requires a bunch of extra effort and processing power to support objects which aren't composed of flat planes.
